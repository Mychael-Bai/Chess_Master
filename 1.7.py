...
class MCTSNode:
    ...
    # Add minimal movement validation methods here
    def _is_valid_move(self, from_pos, to_pos):
        # Implement basic move validation logic here, similar to the original is_valid_move
        # but without dependencies on the full game state
