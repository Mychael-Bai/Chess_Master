...
class MCTSNode:
    ...
    def _is_valid_move(self, from_pos, to_pos, check_for_check=True):
        ...
        # Restore board state
        self.board[from_row][from_pos[1]] = piece
        self.board[to_row][to_col] = original_target
       
        if in_check:
            return False
            
        # Continue with existing move validation...
        # (keep the rest of the existing _is_valid_move code)
...
class MCTS:
    ...
    def __init__(self, game_state, simulation_limit=100):
        self.root = MCTSNode(
...
class ChineseChess:
    ...
    def make_ai_move(self):
        ...
        try:                        
            ...
            max_time = 5  # Maximum 5 seconds for a move
            ...
            if time.time() - start_time > max_time:
                print("AI move took too long, using current best move")
